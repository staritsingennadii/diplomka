                            ...
                            <div class="col-xl-6 ml-auto mr-auto">
                                <div class="card p-4 rounded-plus bg-faded">
                                    <?if(isset($_SESSION["alert"])) {?>
                                        <div class="alert alert-<?=$_SESSION["alert"]["class"];?> text-dark" role="alert">
                                            <strong>Уведомление!</strong> <?=$_SESSION["alert"]["message"];?>
                                        </div>
                                        <?unset($_SESSION["alert"]);?>
                                    <?}?>
                                    <form id="js-login" novalidate="" method="post" action="handler_register.php">
                                        <div class="form-group">
                                            <label class="form-label" for="emailverify">Email</label>
                                            <input name="login" type="email" id="emailverify" class="form-control" placeholder="Эл. адрес" required>
